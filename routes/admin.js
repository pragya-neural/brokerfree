...
router.get('/propertyreport', function(req, res, next) {
  ...
  crud_module.all_data_select('property_id,user_id,property_type,property_purpose_name,apartment_name,no_of_unit,bt.bhk_type,p.active_status',from,where,'user_id desc',function(prop_detail){
    var obj = {};
